...
class MockAuthService {
  async signIn(provider){
    return {name: 'Omkar Raykar', email : 'omkar.ravindraraykar@accolitedigital.com', idToken : 'fafafafaffafafaafafafaafa'};
  }
}
...
class MockAPIService {
  ...
  constructor() {
    ...
    this.data['/login'] = { id: 1, email: 'omkar.ravindraraykar@accolitedigital.com', token: 'valid' };
  }
  callApi(url) {
